...
if __name__ == "__main__":
    ...
    output_dir = "results/2layer_1000_7/"
    ...
    optimizer = optim.Adam(parser.model.parameters(), lr=0.0005, weight_decay = 1e-8)
    ...
    if not debug:
        ...
        parser.model.load_state_dict(torch.load(output_path,map_location=torch.device(device)))
